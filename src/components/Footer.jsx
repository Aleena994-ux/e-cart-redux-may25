...
const Footer = () => {
  return (
    <div style={{ height: '250px', marginTop: '140px' }} className='mt-5 w-full bg-blue-400 text-white p-4'>
      <div className='flex justify-between p-4'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='icons flex justify-between mt-3'>
            ...
            <a href='https://en.wikipedia.org/wiki/Instagram' style={{ textDecoration: 'none', color: 'white' }} target='_blank'>
      ...
      <p className='text-center mt-3 text-white'>
        Copyright &copy; May 2025 Batch, E-cart. Built with React/Redux.
      </p>
    </div>
  )
}
